[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=13am028_automated-clean-code&metric=coverage)](https://sonarcloud.io/summary/new_code?id=13am028_automated-clean-code)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=13am028_automated-clean-code&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=13am028_automated-clean-code)
## Setup Instruction
```
poetry install
```

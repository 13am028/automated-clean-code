...
from automated_clean_code.exercise_20_histlib import MinMax, find_min_max_key, hist, parse, print_min_max


@mock.patch("argparse.ArgumentParser.parse_args", return_value=argparse.Namespace(fname="exercise_20_data.txt"))
def test_parse(mock_args: mock.MagicMock):
